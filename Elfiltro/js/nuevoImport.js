...
export const nombreruta=document.getElementById('nombreruta');
export const minK=document.getElementById('kmin');
export const maxK = document.getElementById('kmax');
export const elestado = document.getElementById('estado');
export const flopacalificacion = document.getElementById('calificacion');
export const lavia = document.getElementById('tipovia');