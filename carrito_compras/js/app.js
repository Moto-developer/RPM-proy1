...
function calcularCantidadTotalCarrito() {
    cantidadTotalCarrito = quitar.reduce((total, producto) => total + producto.cantidad, 0);
}
...
iconoCarrito.addEventListener("mouseover", () => {
    contenidoCarrito.classList.remove('desaparecer');
